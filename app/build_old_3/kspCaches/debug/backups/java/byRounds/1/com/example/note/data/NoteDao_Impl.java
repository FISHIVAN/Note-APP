  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notes` (`id`,`title`,`content`,`timestamp`,`isPinned`,`category`,`tags`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfNote = new EntityDeletionOrUpdateAdapter<Note>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `notes` SET `id` = ?,`title` = ?,`content` = ?,`timestamp` = ?,`isPinned` = ?,`category` = ?,`tags` = ? WHERE `id` = ?";
      }
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Note(_tmpId,_tmpTitle,_tmpContent,_tmpTimestamp,_tmpIsPinned,_tmpCategory,_tmpTags);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Note call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp_1 = _cursor.getString(_cursorIndexOfTags);
            _tmpTags = __converters.toStringList(_tmp_1);
            _result = new Note(_tmpId,_tmpTitle,_tmpContent,_tmpTimestamp,_tmpIsPinned,_tmpCategory,_tmpTags);
          } else {
            _result = null;
          }
          return _result;
